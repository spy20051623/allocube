...
import { ADMIN_BOOKING_BLOCKED_MESSAGE, isAdminBookingBlocked } from "../src/shared/booking-policy.js";
...
export function assertUserCanSubmitReservations(userId: string) {
  ...
  if (user && isAdminBookingBlocked(user.role, settings)) {
    throw new BusinessError(ADMIN_BOOKING_BLOCKED_MESSAGE, 403, undefined, "ADMIN_BOOKING_DISABLED");
  }
}
