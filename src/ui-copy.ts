  ...
  return (
    {
      ...
      MACHINE_ACCESS_REQUEST_EXPIRE: tr("自动拒绝过期使用权申请"),
      MACHINE_ACCESS_REQUEST_EXPIRY: tr("修改申请到期时间"),
      MACHINE_MEMBER_EXPIRY: tr("修改机器使用权期限"),
      RESERVATION_ACCESS_EXPIRY: tr("按授权期限调整占用"),
